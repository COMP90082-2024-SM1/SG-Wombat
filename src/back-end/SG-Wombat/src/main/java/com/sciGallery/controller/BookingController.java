...
public class BookingController {
    ...
    public Result update(@RequestBody Booking booking){
        log.info("根据id更新booking"+JSON.toJSONString(booking));
    ...
    @PutMapping("/booking/todolist")
    public Result updateTodolist(@RequestBody Object todolist){
        log.info("根据id更新booking todolist");
        System.out.println(JSON.toJSONString(todolist));
        bookingService.updateTodolist(todolist);
