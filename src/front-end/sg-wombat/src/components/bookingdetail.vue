<template>
  <el-table ref="tableRef" row-key="bookingID" :data="filteredData" style="width: 100%">
      ...
      <el-table-column prop="tag" label="All Bookings" width="150" :filters="[
          ...
          <template #default="scope">
              <el-tag :type="scope.row.tag === 'Other' ? '' : 'success'" disable-transitions>{{ scope.row.tag }}</el-tag>
          </template>
      </el-table-column>
          ...
          <el-col :span="15">
              ...
              <div v-show="currentStep === 0">
                  <el-descriptions :column="2" size="large" border>
                      ...
                      <el-descriptions-item label="Request Confirmed?">{{ bookingDetails.requestConfirmed }}</el-descriptions-item>
                      ...
                      <el-descriptions-item label="Delivery Location" span="2">{{ bookingDetails.deliveryLocation }}</el-descriptions-item>
                      ...
                      <el-descriptions-item label="Bus Required?">{{ bookingDetails.busRequired }}</el-descriptions-item>
              ...
              <div v-show="currentStep === 1">
                  <el-descriptions :column="2" size="large" border>
                      ...
                      <el-descriptions-item label="Student # (Registered)">{{ bookingDetails.regStudentsNo }}</el-descriptions-item>
                      <el-descriptions-item label="Student # (Attended)">{{ bookingDetails.attendedStudentsNo }}</el-descriptions-item>
                      <el-descriptions-item label="Low SES" span="2">{{ bookingDetails.lowSes }}</el-descriptions-item>
                      <el-descriptions-item label="Accessibility Needs" span="2">{{ bookingDetails.accNeeds }}</el-descriptions-item>
                      <el-descriptions-item label="Allergens & Anaphylaxis" span="2">{{ bookingDetails.allergyNeeds }}</el-descriptions-item>
                      <el-descriptions-item label="Teacher’s Notes" span="2">{{ bookingDetails.teacherNotes }}</el-descriptions-item>
              ...
              <div v-show="currentStep === 3">
                  <el-descriptions :column="2" size="large" border>
                      ...
                      <el-descriptions-item label="Credit Surcharge">{{ bookingDetails.creditSurcharge }}</el-descriptions-item>
                      ...
                      <el-descriptions-item label="Enter into Expense Master">{{ bookingDetails.expenseMaster }}</el-descriptions-item>
